...
luego modificar esto para que tenga un largo proceso que hable de lo que se va a hacer en el proyecto que requerimientos necesita los objetivos a lograr 
que especificaciones tiene, etc...





Ejemplo de lo que se tiene que hacer:
